...
cc.Class({
    ...
    onLoad: function () {
        ...
        this.customBlocks = TerrainBlockConfig.getAllCustomConfig();        //玩家自定义地图块

        this.xbi = 0;    //玩家当前光标，x大坐标
        this.ybi = GlobalConfig.MapSize - 1;   //玩家当前光标，y大坐标
        this.refreshTankPos();
    ...
    moveTankCursor: function( dx, dy ){
        ...
        if( this.isSetting ){
            ...
            this.currCustomBlockIndex--;        //不是设置地图时，换一个位置，恢复到上一个地形样板
        }
    },
